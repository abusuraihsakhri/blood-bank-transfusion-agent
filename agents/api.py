"""
FastAPI REST API Server for Blood Bank Transfusion Agent.
"""
...
app = FastAPI(
    title="Blood Bank Transfusion Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "blood-bank-transfusion-agent", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
