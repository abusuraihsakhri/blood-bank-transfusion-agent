"""
Command-Line Interface for TransfusionGuard: Autonomous Blood Bank Compatibility & Crossmatch Safety Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    ...
    if args.command == "audit":
        ...
        print(f"  Domain: Transfusion Medicine | Standard: AABB Technical Manual 20th Edition")
